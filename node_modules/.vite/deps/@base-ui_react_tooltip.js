...
} from "./chunk-RRPU7KTZ.js";
import {
  DirectionContext,
  getCssDimensions,
  inertValue,
  useDirection
} from "./chunk-BGKI25PK.js";
import {
  Timeout,
  useTimeout
} from "./chunk-P43QXAML.js";
import {
  ACTIVE_KEY,
  FOCUSABLE_ATTRIBUTE,
  SELECTED_KEY,
...
import {
  ...
  isWebKit,
  useStableCallback
} from "./chunk-J4QNYM7M.js";
import {
  useValueAsRef,
  visuallyHidden
} from "./chunk-R3QEE45Z.js";
import {
  useBaseUiId,
  useId
} from "./chunk-QSPP57DF.js";
import {
  require_jsx_runtime
} from "./chunk-H344RCI2.js";
import {
  useIsoLayoutEffect
} from "./chunk-XU7PSY5I.js";
import {
  ...
  useRefWithInit,
  useRenderElement
} from "./chunk-PCNXC6HY.js";
import "./chunk-NTJZ3CEN.js";
import {
  require_react
...
function fastComponentRef(fn) {
  return React.forwardRef(fastComponent(fn));
}
...
var TooltipRootContext = React3.createContext(void 0);
...
function FloatingDelayGroup(props) {
  ...
  const delayRef = React4.useRef(delay);
  const initialDelayRef = React4.useRef(delay);
  const currentIdRef = React4.useRef(null);
  const currentContextRef = React4.useRef(null);
...
function useDelayGroup(context, options = {
  ...
  const groupContext = React4.useContext(FloatingDelayGroupContext);
  const {
    currentIdRef,
    delayRef,
    timeoutMs,
  ...
  const [isInstantPhase, setIsInstantPhase] = React4.useState(false);
  useIsoLayoutEffect(() => {
    function unset() {
      var _a;
...
var PortalContext = React6.createContext(null);
if (true) PortalContext.displayName = "PortalContext";
var usePortalContext = () => React6.useContext(PortalContext);
...
function useFloatingPortalNode(props = {}) {
  ...
  const [containerElement, setContainerElement] = React6.useState(null);
...
var FloatingPortal = React6.forwardRef(function FloatingPortal2(componentProps, forwardedRef) {
  const {
    children,
    container,
    className,
  ...
  const portalContextValue = React6.useMemo(() => ({
    beforeOutsideRef,
    afterOutsideRef,
    beforeInsideRef,
    afterInsideRef,
...
var FloatingNodeContext = React7.createContext(null);
if (true) FloatingNodeContext.displayName = "FloatingNodeContext";
var FloatingTreeContext = React7.createContext(null);
if (true) FloatingTreeContext.displayName = "FloatingTreeContext";
var useFloatingParentNodeId = () => {
  var _a;
  return ((_a = React7.useContext(FloatingNodeContext)) == null ? void 0 : _a.id) || null;
};
var useFloatingTree = (externalTree) => {
  const contextTree = React7.useContext(FloatingTreeContext);
...
function useDismiss(context, props = {}) {
  ...
  const pressStartedInsideRef = React11.useRef(false);
  const pressStartPreventedRef = React11.useRef(false);
  const suppressNextOutsideClickRef = React11.useRef(false);
  const {
    escapeKey: escapeKeyBubbles,
    outsidePress: outsidePressBubbles
  } = normalizeProp(bubbles);
  const touchStateRef = React11.useRef(null);
  ...
  const currentPointerTypeRef = React11.useRef("");
  ...
  React11.useEffect(clearInsideReactTree, [outsidePress, clearInsideReactTree]);
...
var ReactStore = class extends Store {
  ...
  useSyncedValues(statePart) {
    const store = this;
    if (true) {
      React14.useDebugValue(statePart, (p) => Object.keys(p));
...
function useTriggerRegistration(id, store) {
  const registeredElementIdRef = React16.useRef(null);
  const registeredElementRef = React16.useRef(null);
...
function useFloating2(options = {}) {
  ...
  const [positionReference, setPositionReferenceRaw] = React17.useState(null);
  const domReferenceRef = React17.useRef(null);
  const tree = useFloatingTree(externalTree);
  useIsoLayoutEffect(() => {
  ...
  const setPositionReference = React17.useCallback((node) => {
  ...
  const [localDomReference, setLocalDomReference] = React17.useState(null);
  const [localFloatingElement, setLocalFloatingElement] = React17.useState(null);
...
function useFocus(context, props = {}) {
  ...
  const blockedReferenceRef = React18.useRef(null);
  const timeout = useTimeout();
...
function useHoverFloatingInteraction(context, parameters = {}) {
  ...
  const closeWithDelay = React19.useCallback((event) => {
...
function useHoverReferenceInteraction(context, props = {}) {
  ...
  const closeWithDelay = React20.useCallback((event, runElseBranch = true) => {
  ...
  React20.useEffect(() => cleanupMouseMoveHandler, [cleanupMouseMoveHandler]);
  const clearPointerEvents = useStableCallback(() => {
    clearSafePolygonPointerEventsMutation(instance);
  });
  React20.useEffect(() => {
...
function useInteractions(propsList = []) {
  ...
  const getReferenceProps = React22.useCallback(
    (userProps) => mergeProps(userProps, propsList, "reference"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    referenceDeps
  );
  const getFloatingProps = React22.useCallback(
    (userProps) => mergeProps(userProps, propsList, "floating"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    floatingDeps
  );
  const getItemProps = React22.useCallback(
    (userProps) => mergeProps(userProps, propsList, "item"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    itemDeps
  );
  const getTriggerProps = React22.useCallback(
...
var TooltipStore = class _TooltipStore extends ReactStore {
  constructor(initialState) {
    ...
    __publicField(this, "setOpen", (nextOpen, eventDetails) => {
      ...
      if (isHover) {
        ReactDOM5.flushSync(changeState);
      } else {
        changeState();
      }
    });
...
var TooltipRoot = fastComponent(function TooltipRoot2(props) {
  ...
  const previousInstantTypeRef = React27.useRef(null);
  useIsoLayoutEffect(() => {
  ...
  const activeTriggerProps = React27.useMemo(() => getReferenceProps(), [getReferenceProps]);
  const inactiveTriggerProps = React27.useMemo(() => getTriggerProps(), [getTriggerProps]);
  const popupProps = React27.useMemo(() => getFloatingProps(), [getFloatingProps]);
  store.useSyncedValues({
    activeTriggerProps,
    inactiveTriggerProps,
    popupProps
  });
  return (0, import_jsx_runtime7.jsx)(TooltipRootContext.Provider, {
    value: store,
...
var TooltipProviderContext = React28.createContext(void 0);
if (true) TooltipProviderContext.displayName = "TooltipProviderContext";
function useTooltipProviderContext() {
  return React28.useContext(TooltipProviderContext);
}
...
var TooltipTrigger = fastComponentRef(function TooltipTrigger2(componentProps, forwardedRef) {
  ...
  const floatingRootContext = store.useState("floatingRootContext");
  const triggerElementRef = React29.useRef(null);
...
var TooltipPortalContext = React30.createContext(void 0);
if (true) TooltipPortalContext.displayName = "TooltipPortalContext";
function useTooltipPortalContext() {
  const value = React30.useContext(TooltipPortalContext);
  if (value === void 0) {
...
var FloatingPortalLite = React31.forwardRef(function FloatingPortalLite2(componentProps, forwardedRef) {
  const {
    children,
    container,
    className,
  ...
  return (0, import_jsx_runtime8.jsxs)(React31.Fragment, {
    children: [portalSubtree, portalNode && ReactDOM6.createPortal(children, portalNode)]
  });
});
...
var TooltipPortal = React32.forwardRef(function TooltipPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
  ...
  return (0, import_jsx_runtime9.jsx)(TooltipPortalContext.Provider, {
    value: keepMounted,
    children: (0, import_jsx_runtime9.jsx)(FloatingPortalLite, {
      ref: forwardedRef,
      ...portalProps
    })
  });
...
var TooltipPositionerContext = React33.createContext(void 0);
if (true) TooltipPositionerContext.displayName = "TooltipPositionerContext";
function useTooltipPositionerContext() {
  const context = React33.useContext(TooltipPositionerContext);
  if (context === void 0) {
...
var adaptiveOrigin = {
  ...
  async fn(state) {
    ...
    const offsetParent = await ((_a = platform2.getOffsetParent) == null ? void 0 : _a.call(platform2, floating));
    ...
    } else if (await ((_b = platform2.isElement) == null ? void 0 : _b.call(platform2, offsetParent))) {
...
var TooltipPositioner = React35.forwardRef(function TooltipPositioner2(componentProps, forwardedRef) {
  const {
    render,
    className,
    anchor,
  ...
  const defaultProps = React35.useMemo(() => {
    const hiddenStyles = {};
  ...
  return (0, import_jsx_runtime10.jsx)(TooltipPositionerContext.Provider, {
    value: contextValue,
    children: element
  });
});
...
var TooltipPopup = React36.forwardRef(function TooltipPopup2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
...
var TooltipArrow = React37.forwardRef(function TooltipArrow2(componentProps, forwardedRef) {
  const {
    className,
    render,
    ...elementProps
...
var TooltipProvider = function TooltipProvider2(props) {
  ...
  const delayValue = React38.useMemo(() => ({
    open: delay,
    close: closeDelay
  }), [delay, closeDelay]);
  return (0, import_jsx_runtime11.jsx)(TooltipProviderContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime11.jsx)(FloatingDelayGroup, {
      delay: delayValue,
      timeoutMs: timeout,
...
function usePopupAutoResize(parameters) {
  ...
  const committedDimensionsRef = React40.useRef(null);
  const liveDimensionsRef = React40.useRef(null);
  const isInitialRenderRef = React40.useRef(true);
  const restoreAnchoringStylesRef = React40.useRef(NOOP);
  const onMeasureLayout = useStableCallback(onMeasureLayoutParam);
  const onMeasureLayoutComplete = useStableCallback(onMeasureLayoutCompleteParam);
  const anchoringStyles = React40.useMemo(() => {
...
function usePopupViewport(parameters) {
  ...
  const [previousContentNode, setPreviousContentNode] = React42.useState(null);
  const [newTriggerOffset, setNewTriggerOffset] = React42.useState(null);
  const currentContainerRef = React42.useRef(null);
  const previousContainerRef = React42.useRef(null);
  ...
  const lastHandledTriggerRef = React42.useRef(null);
  useIsoLayoutEffect(() => {
  ...
  if (!isTransitioning) {
    ...
    childrenToRender = (0, import_jsx_runtime13.jsxs)(React42.Fragment, {
...
function usePopupContentKey(activeTriggerId, payload) {
  const [contentKey, setContentKey] = React42.useState(0);
  const previousActiveTriggerIdRef = React42.useRef(activeTriggerId);
  const previousPayloadRef = React42.useRef(payload);
  const pendingPayloadUpdateRef = React42.useRef(false);
  useIsoLayoutEffect(() => {
...
var TooltipViewport = React43.forwardRef(function TooltipViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    children,
